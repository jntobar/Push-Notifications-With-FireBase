...
import 'package:push_app/presentation/blocs/local_notifications/local_notifications.dart';
...
class NotificationsBloc extends Bloc<NotificationsEvent, NotificationsState> {
  ...
  NotificationsBloc({this.requestLocalNotificationPermissions, this.showLocalNotification}) : super(const NotificationsState()) {
